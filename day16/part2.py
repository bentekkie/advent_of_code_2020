import re
import math
t=[79,193,53,97,137,179,131,73,191,139,197,181,67,71,211,199,167,61,59,127]
...
print(math.prod(t[v]for k,v in q({},set(s),set(range(len(w)))).items() if"departure"in k))